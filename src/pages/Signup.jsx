                            ...
                            <form onSubmit={handleSubmit(signupSubmit)}>
                                ...
                                <div className="w-full flex justify-center">
                                    <div className="relative">
                                        <img className="size-24 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={profilePhoto ? profilePhoto : "https://res.cloudinary.com/dllphjlv3/image/upload/f_auto,q_auto/ut3hb62wndfelslnpd7m"} alt="profile Photo" />
                                ...
                                <Button type="submit" children="Signup" className="w-full rounded-md mt-2" />
                            </form>
                            <span className=" text-sm text-gray-700">Already have Account? <Link to={"/login"} className=" text-blue-900">login now</Link></span>
                        </div>
