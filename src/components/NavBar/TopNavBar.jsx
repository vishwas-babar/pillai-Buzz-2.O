    ...
    return (
        <>
            ...
            >
                ...
                >
                    {/* <img class="h-[60px] w-[60px] rounded-full bg-contain" src="../public/images/Pillaipo.png" alt=""> */}
                    <img
                ...
                <div className="gap-[10px] items-center w-fit h-full hidden md:flex">
                    <NavLink
                        to="/"
                        className={({ isActive }) => `${isActive ? ' bg-custom-primary text-white' : ''} rounded-[20px] hover:bg-custom-primary hover:text-white hover:shadow-md px-[20px] py-[10px] transition-all duration-[0.3s] ease-in-out`}
                    >
                        My Feed
                    </NavLink>
                    <NavLink
                ...
                <div className="flex items-center justify-center ml-[10px] gap-[10px]">
                    ...
                    >
                        <a id="profile-btn" class="overflow-hidden">
                            <img id="profile-photo-nav" src={userpng} class="rounded-full" alt="" />
                        </a>
                    </div>
                </div>
            </nav>
            ...
            <div id="side-nav-overlay" className="w-full h-full fixed left-0 top-0 bg-black opacity-50 z-20 hidden"></div>
